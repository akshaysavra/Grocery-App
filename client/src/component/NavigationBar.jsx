  ...
  return (
     <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <NavLink to='/' onClick={()=>{setOpen(false)}}>
                <img className="h-9" src={assets.logo} alt="MainLogo" />
            </NavLink>
            ...
            <div className="hidden sm:flex items-center gap-8">
               <NavLink to='/'>Home</NavLink>
                ...
                <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full">
                    <input onChange={(e)=>{setSearchQuery(e.target.value.trim())}} className="py-1.5 w-full bg-transparent outline-none placeholder-gray-500" type="text" placeholder="Search products" />
                   <img src={assets.search_icon} className='' alt="search icon" />
                </div>
                ...
                : (
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gra-200py-2.5 w-30 rounded-md text-sm z-40'>
                            <li onClick = {()=>{navigate("my-orders")}} className='p-1.5 pl-3 hover:bg-primary/10 cursor-pointer '> My Order</li>
                            <li className='p-1.5 pl-3 hover:bg-primary/10 cursor-pointer' onClick={logOut}>Log Out</li>
